...
def get_args():
    parser = argparse.ArgumentParser(description="CLPC Args")
    ######################## general settings ########################
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='itc+cdm+chm', help="which loss to use ['ndm', 'dmt, 'fcm', 'ccm']")
    ...
    parser.add_argument("--sampler", default="random", help="choose sampler from [idtentity, random, cluster]")
    ...
    ######################## momentum ########################
    parser.add_argument("--momentum", default=0.995, type=float, help="momentum of updating key encoder (default: 0.999)",
)
